...
# ID = list(range(1,5))
lst = [
['Country_1', 'Country_2', '1980-03-04', '1980-03-04 14:20:51'],
['Country_2', 'Country_3', '2021-03-04', '1980-03-04 14:20:51'],
['Country_5', 'Country_1', '2021-11-01', '1980-03-04 14:20:51'],
['Country_4', 'Country_2', '2022-11-01', '1980-03-04 14:20:51'],
['Country_3', 'Country_1', '2021-11-01', '2021-11-01 10:20:00'],
['Country_2', 'Country_1', '2021-11-26', '2021-11-01 10:44:00'],
['Country_2', 'Country_6', '2021-11-26', '2021-11-01 10:45:00'],
['Country_2', 'Country_6', '2021-11-26', '2021-11-01 10:46:00'],
['Country_2', 'Country_6', '2021-11-26', '2021-11-01 10:49:00']
]

for i in lst:
    Matches(country_1 = i[0], country_2 = i[1] , date = i[2], created_at = i[3]).save()
